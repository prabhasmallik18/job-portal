          ...
          <tbody>
            {viewApplicationsPageData.map((applicant, index) => (
              <tr key={index} className='text-gray-700'>
                ...
                <td className='py-2 px-4 border-b max-sm:hidden'>{applicant.jobTitle}  {applicant.img}</td>
                <td className='py-2 px-4 border-b max-sm:hidden'>{applicant.location}</td>
                <td className='py-2 px-4 border-b'>
                  <a href="" target='_blank' className='bg-blue-50 text-blue-400 px-3 py-1 rounded inline-flex items-center gap-2'>
                ...
                <td className='py-2 px-4 border-b relative'>
                  <div className='relative inline-block text-left group'>
                    ...
                    <div className='z-10 hidden group-hover:block absolute right-0 md:left-0 top-0 mt-2 w-32 bg-white border border-gray-200 rounded shadow-md'>
